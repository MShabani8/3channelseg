...
import DatePicker from '../components/Date_Time'
...
const Home = () => {
  ...
  return (
    <div className='container lg:pt-16 pt-28 2xl:px-28 xl:px-16 lg:px-12 px-7  mx-auto max-w-screen-custom'>
      ...
      <h1>lir</h1>
      <div class='w-full mx-auto bg-white  py-10 text-gray-600 mb-10'>
        <div class='max-w-5xl mx-auto md:flex'>
          ...
          <div class='md:w-3/4'>
            <div class='max-w-4xl mx-auto md:flex'>
              ...
              <div class='w-full md:w-1/3 md:max-w-none bg-white px-8 md:px-10 py-8 md:py-10 mb-3 mx-auto md:-mx-3 md:mb-0 rounded-md shadow-lg shadow-gray-600 md:relative md:z-40 md:flex md:flex-col'>
                <div class='w-full flex-grow'>
